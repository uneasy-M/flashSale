...
public class RedisUtil{
	...
	public void del(KeyPrefix prfix,String key) {
		del(prfix+key);
	}
	 ...
	 */
	public <T> boolean set(KeyPrefix prefix, String key, Object value, long time) {
		try {
			if (value == null) {
				return false;
			}
